...
return [
    ...
    'password'               => [
        'letters'       => 'La password deve contenere almeno un carattere.',
        'mixed'         => 'La password deve contenere almeno un carattere maiuscolo ed un carattere minuscolo.',
        'numbers'       => 'La password deve contenere almeno un numero.',
        'symbols'       => 'La password deve contenere almeno un simbolo.',
        'uncompromised' => 'La password è presente negli archivi dei dati trafugati. Per piacere scegli un valore differente per :attribute.',
    ],
